...
def index():
    ...
    return render_template("index.html",brokenlaptops=brokenlaptops,title = 'Welcome to laptop Inventory')
...
def create():
    ...
    brokenlaptops = BrokenLaptop.query.all()
    return render_template("create.html",brokenlaptops=brokenlaptops,title = 'Add new laptop to Inventory')    
...
def update(laptop_id):
    ...
    brokenlaptop = BrokenLaptop.query.get(laptop_id)
    return render_template("update.html",brokenlaptop=brokenlaptop, title = 'Update laptop Inventory')
